...
"[project]/app/(store)/collections/[category]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CategoryPage() {
    ...
    const products = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductsByCategory"])(category);
    ...
    const allSizes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CategoryPage.useMemo[allSizes]": ()=>{
            const sizes = new Set();
            products.forEach({
                "CategoryPage.useMemo[allSizes]": (p)=>p.sizes.forEach({
                        "CategoryPage.useMemo[allSizes]": (s)=>sizes.add(s)
                    }["CategoryPage.useMemo[allSizes]"])
            }["CategoryPage.useMemo[allSizes]"]);
    ...
    const allColors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CategoryPage.useMemo[allColors]": ()=>{
            const colors = new Set();
            products.forEach({
                "CategoryPage.useMemo[allColors]": (p)=>p.colors.forEach({
                        "CategoryPage.useMemo[allColors]": (c)=>colors.add(c)
                    }["CategoryPage.useMemo[allColors]"])
            }["CategoryPage.useMemo[allColors]"]);
        ...
        "CategoryPage.useMemo[filteredProducts]": ()=>{
            return products.filter({
                "CategoryPage.useMemo[filteredProducts]": (product)=>{
                    const sizeMatch = selectedSizes.length === 0 || product.sizes.some({
                        "CategoryPage.useMemo[filteredProducts]": (s)=>selectedSizes.includes(s)
                    }["CategoryPage.useMemo[filteredProducts]"]);
                    const colorMatch = selectedColors.length === 0 || product.colors.some({
                        "CategoryPage.useMemo[filteredProducts]": (c)=>selectedColors.includes(c)
                    }["CategoryPage.useMemo[filteredProducts]"]);
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: allSizes.map((size)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(CategoryPage, "VjCcHvrK2vfmQqU+nCszuqfDsQA=", false, function() {
    return [
...
//# sourceMappingURL=_2a620810._.js.map